...
int main() {
    #define MAX_SIZE 1000 // לא הוזכר מה אורך התווים המקסימלי, אז בחרתי בעצמי (בלי גבול תווים הזיכרון היה יכול לחרוג)
    ...
    if (result_size == 0)  // אם המערך ריק, נדפיס NULL כדי להודיע זאת
        printf("NULL");
    else
